// ============================================
// lib/presentation/settings/desktop_background/desktop_background_settings_screen.dart
// ============================================
...
class DesktopBackgroundSettingsScreen extends StatefulWidget {
  ...
  @override
  State<DesktopBackgroundSettingsScreen> createState() =>
      _DesktopBackgroundSettingsScreenState();
}

class _DesktopBackgroundSettingsScreenState
    extends State<DesktopBackgroundSettingsScreen> {
    ...
    return Column(
      children: [
        ...
        CupertinoListSection.insetGrouped(
          children: [
            CupertinoListTile(
              title: const Text('Загрузить новый',
