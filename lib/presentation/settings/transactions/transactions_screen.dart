// ============================================
// lib/presentation/settings/transactions/transactions_screen.dart
// ============================================
      ...
      builder: (ctx) => CupertinoAlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildDetailRow('Гость',
                '${transaction.guest.lastName} ${transaction.guest.firstName} ${transaction.guest.surname}'),
            const Divider(height: 16),
            ...
            if (transaction.services.isNotEmpty) ...[
              ...
              ...transaction.services.map((service) => Padding(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      _getPaymentColor(transaction.paymentType).withValues(alpha: 0.2),
