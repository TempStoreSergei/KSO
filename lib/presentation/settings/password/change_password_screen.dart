...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final UpdatePasswordUseCase updatePasswordUseCase =
        UpdatePasswordUseCase(settingsRepository);
...
class _ChangePasswordViewState extends State<_ChangePasswordView> {
  ...
  Future<void> _updatePassword() async {
    final updatePasswordUseCase =
        Provider.of<UpdatePasswordUseCase>(context, listen: false);
    ...
    final navigationBar = CupertinoNavigationBar(
      ...
      trailing: CupertinoButton(
        ...
        child: _isLoading
            ...
            : const Text('Готово', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoTextField(
      ...
      placeholderStyle: const TextStyle(
          fontSize: largeFontSize, color: CupertinoColors.placeholderText),
